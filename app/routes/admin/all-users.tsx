        ...
        <main className='all-users wrapper'>
            ...
            <GridComponent dataSource={users} gridLines='None'>
                <ColumnsDirective>
                    <ColumnDirective field='name' headerText='Name' width='200' textAlign='Left'
                        template={(props: UserData) => (
                            <div className='flex items-center gap-2'>
                                <img src={props.imageUrl} alt={props.name} className='size-8 rounded-full aspect-square' />
                    ...
                    <ColumnDirective field='dateJoined' headerText='Date Joined' width='120' textAlign='Left' />

                    <ColumnDirective field='itineraryCreated' headerText='Trip Created' width='150' textAlign='Left' />
                    <ColumnDirective
                        field="status"
                        headerText="Type"
                        width="100"
